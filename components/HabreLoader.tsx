...
export const HabreLoader: React.FC = () => {
  ...
  const posterUrl = "https://auopgtcysaaexozjgcbh.supabase.co/storage/v1/object/public/Assets/Habre_doing_Namaste-removebg-preview.png";
  const signatureGradient = "linear-gradient(90deg, #FF4B4B, #4F93FF)";

  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] w-full py-10 px-4">
      {/* The Video Container */}
      <div className="relative group">
        ...
        />
        <div className="relative w-56 h-56 sm:w-64 sm:h-64 rounded-[3rem] overflow-hidden shadow-2xl bg-white border-[6px] border-white">
          <video 
            autoPlay 
            loop 
            muted 
      ...
      <div className="mt-12 text-center max-w-xs">
        <h2 className="text-2xl font-black text-slate-800 tracking-tight flex items-center justify-center gap-2">
          Habre Dai Khojdai Hunuhunchha. <span className="animate-bounce">🕺</span>
        </h2>
        <p className="text-slate-400 font-bold mt-3 text-[11px] uppercase tracking-[0.2em]">
          Ekchhin Pratikshya Garnuhos...
        </p>
      </div>
