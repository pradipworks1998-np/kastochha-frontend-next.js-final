...
export default function BlogListing({ posts }: BlogListingProps) {
  return (
    <>
      {/* Keeping your exact original custom CSS for the gradient hover */}
          ...
          return (
            <article key={sys.id} className="group flex flex-col">
              {fields.featuredImage && (
                ...
                >
                  {/* SEO/Performance Fix (Invisible): 
                    Using your original <img> to guarantee the layout stays identical, 
                    but added decoding="async" for faster page rendering.
                  */}
                  <img
